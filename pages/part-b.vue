    ...
    <div>
      ...
      <div class="container">
        ...
        <div class="display-grid">
          <section>
            <h5 v-if="isOriginal">Result: {{ rawUsers.length }} items</h5>
...
const groupData = (type: string) => {
  ...
  const allGroups = groupBy(productList, 'type');
  // console.log('allGroups:', allGroups);
  filteredResult.value = allGroups[type] || productList;
...
const resultUsers = removeDuplicates(rawUsers);
const showData = computed(() => isOriginal.value ? rawUsers : resultUsers);
